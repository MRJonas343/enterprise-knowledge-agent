...
| [004](004-use-fastapi-as-application-gateway.md) | Use FastAPI as the application gateway | Planned |
| [005](005-use-mcp-for-runtime-tools.md) | Use MCP for governed runtime tools | Planned |
